<template>
  <div class="bg-purple-dark-prim relative py-20 text-white">
    ...
    <div class="grid md:grid-cols-3 grid-cols-1 gap-4">
      <div>
        <h1
          class="text-left sm:text-3xl text-4xl sm:py-20 font-bold text-white"
        >
          Cele projektu
        </h1>
        <img
...
const reasons = [
  {
    ...
    name: "Edukacja",
    des: "Promowanie zdrowego stylu życia i dbającego o zdrowie psychiczne podejścia do życia.",
  },
  {
    icon: "M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z",
    name: "Świadomość",
    des: "Zwiększanie świadomości i zrozumienia chorób psychicznych oraz sposobów radzenia sobie z nimi.",
  },
  {
    ...
    name: "Brak Stygmatyzacji",
    des: "Zmniejszanie stygmatyzacji związanej z chorobami psychicznymi poprzez edukację i promocję zdrowego podejścia do zdrowia psychicznego.",
  },
  {
    ...
    name: "Równowaga",
    des: "Wspieranie zrównoważonego i zdrowego społeczeństwa poprzez promowanie zdrowego stylu życia i podejścia do zdrowia psychicznego.",
  },
];
</script>
